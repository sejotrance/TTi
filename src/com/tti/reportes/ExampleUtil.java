...
public final class ExampleUtil {
    ...
    private static final String[] iso3166 = new String[] { "AFGHANISTAN", "AF",
            "ￜￜLAND ISLANDS", "AX", "ALBANIA", "AL", "ALGERIA", "DZ",
            ...
            "COOK ISLANDS", "CK", "COSTA RICA", "CR", "CￜￜTE D'IVOIRE", "CI",
            ...
            "SAINT BARTHￜￜLEMY", "BL", "SAINT HELENA", "SH",
    ...
    public static final Object NOMBRE = "Nombre";
    public static final Object PROMEDIO_NOTAS = "Avance Promedio";
    public static final Object CARRERA = "Carrera";
    public static final Object CALIFICACIONES = "Calificaciones";
    ...
    public static IndexedContainer getOrderContainer() {
        ...
        container.addContainerProperty(NOMBRE,
                String.class, "");
        container.addContainerProperty(PROMEDIO_NOTAS,
                Double.class, 0);
        container.addContainerProperty(CARRERA,
        		String.class, 0);
        container.addContainerProperty(CALIFICACIONES,
        		Integer.class, 0);

        // Create some orders
        addOrderToContainer(container, "KARIN ACU�A", 60.4, "21030", 3);
        addOrderToContainer(container, "JOSE HURTADO", 65.2, "21030", 2);
        addOrderToContainer(container, "CRISTIAN QUEVEDO", 50, "21041",1);
        addOrderToContainer(container, "ESTEBAN GUTIERREZ", 40.3, "21041",1);
        addOrderToContainer(container, "CARLA VILLAGRAN", 60, "21030" , 3);
        addOrderToContainer(container, "PABLO JACOBI", 65.8, "21030", 4);
        addOrderToContainer(container, "PAMELA FUENTES", 50.1, "21041", 6);
        addOrderToContainer(container, "RODRIGO LOPEZ", 40.9, "21030",4);
    ...
    private static void addOrderToContainer(Container container,
            String nombre, double promedio, String carrera, int calificaciones) {
        Object itemId = container.addItem();
        Item item = container.getItem(itemId);
        item.getItemProperty(NOMBRE).setValue(
        		nombre);
        item.getItemProperty(PROMEDIO_NOTAS).setValue(promedio);
        item.getItemProperty(CARRERA).setValue(carrera);
        item.getItemProperty(CALIFICACIONES).setValue(calificaciones);
